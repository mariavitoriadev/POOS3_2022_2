...
public class Principal {
    public static void main(String[] args) {
        ...
        //Polimorfismo
        //Lista é da classe Pessoa, porém estamos
        // adicionando objetos das classes
        // Professor, AlunoGraduacao e AlunoPosGrduacao
        List<Pessoa> lista = new ArrayList<>();
        lista.add(professor);
        lista.add(alunoGraduacao);
        lista.add(alunoPosGraduacao);

        //Outra forma para adicionar objetos na lista:
